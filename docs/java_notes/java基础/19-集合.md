...
<img src="https://img.xbin.cn/images/2024/03/05-21-26-01fcf5.png" alt="1706260567430" style="zoom:80%;" />
...
====================================
最终结论:我们调用了add方法,而add方法底层只给modCount++,但是再次调用next方法的时候,并没有给修改后的modCount重新赋值给expectedModCount,导致next方法底层的判断判断出实际操作次数和预期操作次数不相等了,所以抛出了并发修改异常
```
...
<img src="https://img.xbin.cn/images/2024/03/05-21-26-9238d0.png" alt="1706264487008" style="zoom:80%;" />
...
![模块18总结](https://img.xbin.cn/images/2024/04/13-15-48-fd8853.png)
