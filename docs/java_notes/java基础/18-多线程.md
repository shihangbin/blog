...
| 方法             | 说明                                                                                  |
| ---------------- | ------------------------------------------------------------------------------------- |
| void wait()      | 线程等待,等待的过程中线程会释放锁,需要被其他线程调用 notify 方法将其唤醒,重新抢锁执行 |
| void notify()    | 线程唤醒,一次唤醒一个等待线程;如果有多条线程等待,则随机唤醒一条等待线程               |
| void notifyAll() | 唤醒所有等待线程                                                                      |

> wait 和 notify 方法需要锁对象调用,所以需要用到同步代码块中,而且必须是同一个锁对象

<img src="https://img.xbin.cn/images/2024/03/05-21-26-3bfe5f.png" alt="1705301228993" style="zoom:80%;" />![1705304702403](https://img.xbin.cn/images/2024/03/05-21-26-bca7ee.png)
...
<img src="https://img.xbin.cn/images/2024/03/05-21-26-23598e.png" alt="1705304707790" style="zoom:80%;" />
...
### 1.解决多生产多消费问题(if 改为 while,将 notify 改为 notifyAll)
...
<img src="https://img.xbin.cn/images/2024/03/05-21-26-9c596a.png" alt="1705317722345" style="zoom:80%;" />
...
![模块17总结](https://img.xbin.cn/images/2024/04/13-15-51-2c2b45.png)
