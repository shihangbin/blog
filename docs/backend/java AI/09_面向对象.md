...
<img src="https://img.xbin.cn/blog/20260405175108059.png" alt="image-20251025091533328" style="zoom:80%;" />

#### `1.1.javabean` 在开发中的实际运用\`\_` 添加功能

<img src="https://img.xbin.cn/blog/20260405175108060.png" alt="image-20251025094007621" style="zoom:80%;" />

> 封装页面上发送过来的数据,一层一层传递到 `dao` 层,在 `dao` 层中调用 `javabean` 对象中的 `getxxx` 方法,将属性值获取出来,放到 `sql` 语句中

#### `1.2.javabean` 在实际开发中运用\`\_` 查询功能

<img src="https://img.xbin.cn/blog/20260405175108061.png" alt="image-20251025095448752" style="zoom:80%;" />
...
<img src="https://img.xbin.cn/blog/20260405175108062.png" alt="image-20251025141437049" style="zoom:80%;" />
...
> 练习:定义一个学生类,声明姓名,年龄,分数,创建 `5` 个学生对象为属性赋值,然后按照分数排序
...
<img src="https://img.xbin.cn/blog/20260405175108063.png" alt="image-20251025152909978" style="zoom:80%;" />
...
<img src="https://img.xbin.cn/blog/20260405175108064.png" alt="image-20251025164246370" style="zoom:80%;" />
