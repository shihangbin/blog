## 第一章.`PreparedStatement` 预处理对象

### `1.PreparedStatement` 实现批量添加
...
<img src="https://img.xbin.cn/blog/20260405171130241.png" alt="image-20251117091422093" style="zoom:80%;" />
...
<img src="https://img.xbin.cn/blog/20260405171130242.png" alt="1755070316108" style="zoom:80%;" />
...
### `3`.获取 `Class` 对象中的构造方法\`\_Constructor`
...
> `1`.知道反射是解剖 `class` 对象的
>
> `2`.知道反射解剖出 `class` 对象中的构造,属性,方法都要干啥
>
> `3`.了解调用哪些方法是操作属性的,调用哪些方法是操作构造的,调用哪些方法是操作方法的->当一套 `api` 学
>
